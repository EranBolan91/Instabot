        ...
        try:
            for user in dm_users:
                ...
                try:
                    ...
                    DMDB().remove_dm_user_from_list(user[0], group_id)
                    sent += 1
                    print('Removed user from distribution list: ', user[0])
                ...
                try:
                    ...
                    try:
                        ...
                        print('Removed user from distribution list and database: ', user[0])
                    except Exception as e:
                        pass
                except Exception as e:
                    pass
