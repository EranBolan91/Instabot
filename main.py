...
# TODO: add to DM text box that limit messages
# TODO: write error message function on 'main_bot' to use on all other classes
# TODO: add limit box on unfollowers that limits how many users to unfollow
# TODO: on the statistic page, create box details for every account that display his all actions
# TODO: add reverse in unfollow
...
# TODO: add limit box to unfollow
